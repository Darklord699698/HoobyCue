...
export default function Footer() {
  ...
  return (
    <>
      <footer className="bg-stone-50 text-black py-16 relative">
      ...
      <div className="bg-purple-100 text-gray-400 text-center py-4">
      ...
      {showTopButton && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-20 right-8 bg-blue-500 text-white p-3 rounded-full shadow-lg hover:bg-blue-600 transition-all"
