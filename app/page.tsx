...
//start
  ...
  <div className="w-full max-w-7xl mx-auto flex flex-col items-center px-8 py-16">
    <section className="w-full flex flex-col items-start px-8 lg:px-0 space-y-8 mb-16 relative">
      ...
      <div className="absolute top-4 right-4 sm:right-20 flex space-x-4">
        {isLoggedIn ? (
      ...
      <div className="absolute top-20 right-0 w-50 sm:w-30 max-w-lg mx-auto p-6 bg-white rounded-lg shadow-md border mt-8 sm:ml-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 justify-center">
        {boxes.map((box) => (
          <div
            ...
            } w-full sm:w-[400px] lg:w-[500px] hover:bg-purple-100 hover:border-purple-500 hover:shadow-xl hover:scale-105`}
          >
            {editBoxId === box.id ? (
        ...
        {/* Add New Box */}
        <div className="p-8 border border-dashed border-gray-300 rounded-lg text-center bg-white shadow-lg w-full sm:w-[400px] lg:w-[500px] hover:bg-green-100 hover:border-green-500 hover:shadow-xl hover:scale-105">
          <button
...
<section className="w-full bg-purple-600 p-8 mt-16 rounded-lg flex flex-col space-y-4">
  ...
  <div className="flex items-center space-x-2">
    ...
    <p className="text-white font-bold text-lg sm:text-xl lg:text-2xl">Testimonials</p>
  </div>
  ...
  <div className="flex items-center justify-center space-x-4">
    ...
    <audio controls className="w-1/2 sm:w-2/3 lg:w-1/2">
    ...
    <div className="flex items-center space-x-2">
      ...
      <div className="text-white">
        <p className="font-bold text-lg sm:text-xl">Ryan Reynolds</p>
        <p className="text-sm sm:text-base">Actor</p>
      </div>
    </div>
  </div>
</section>
...
<section className="relative w-full mt-16">
  ...
  {/* Text Overlay */}
  <div className="absolute top-4 left-4 text-white sm:left-8 lg:left-16 sm:top-8 lg:top-16">
    <h2 className="text-3xl font-bold sm:text-4xl lg:text-5xl">Your Hobby, Your Community</h2>
